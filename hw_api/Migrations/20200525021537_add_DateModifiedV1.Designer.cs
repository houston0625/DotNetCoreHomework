...
namespace hw_api.Migrations
{
    ...
    [Migration("20200525021537_add_DateModifiedV1")]
    partial class add_DateModifiedV1
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("hw_api.Models.Course", b =>
                {
            ...
            modelBuilder.Entity("hw_api.Models.CourseInstructor", b =>
                {
                    b.Property<int>("CourseId")
                        .HasColumnName("CourseID")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("hw_api.Models.Department", b =>
                {
                    b.Property<int>("DepartmentId")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("DepartmentID")
            ...
            modelBuilder.Entity("hw_api.Models.Enrollment", b =>
                {
            ...
            modelBuilder.Entity("hw_api.Models.OfficeAssignment", b =>
                {
                    b.Property<int>("InstructorId")
                        .HasColumnName("InstructorID")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("hw_api.Models.Person", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("ID")
            ...
            modelBuilder.Entity("hw_api.Models.Course", b =>
                {
                    b.HasOne("hw_api.Models.Department", "Department")
                        .WithMany("Course")
            ...
            modelBuilder.Entity("hw_api.Models.CourseInstructor", b =>
                {
                    b.HasOne("hw_api.Models.Course", "Course")
                    ...
                    b.HasOne("hw_api.Models.Person", "Instructor")
                        .WithMany("CourseInstructor")
            ...
            modelBuilder.Entity("hw_api.Models.Enrollment", b =>
                {
                    ...
                    b.HasOne("hw_api.Models.Person", "Student")
                        .WithMany("Enrollment")
            ...
            modelBuilder.Entity("hw_api.Models.OfficeAssignment", b =>
                {
                    b.HasOne("hw_api.Models.Person", "Instructor")
                        ...
                        .HasForeignKey("hw_api.Models.OfficeAssignment", "InstructorId")
